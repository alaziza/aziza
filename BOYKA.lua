...
sudo_users = {SUDO,1183747742,1474241368,1492525660}   
...
var = true  
elseif tonumber(user_id) == tonumber(1474241368) then
var = true  
elseif tonumber(user_id) == tonumber(1492525660) then
var = true
...
os.execute('wget https://raw.githubusercontent.com/alaziza/aziza/master/BOYKA.lua')
send(msg.chat_id_, msg.id_,' ☻ تم تحديث السورس \n ☻ لديك اخر اصدار لسورس العزايزي\n ☻ الاصدار » { 1.3v}')
dofile('BOYKA.lua')  
end
if text == 'الاصدار ☻' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ☻ اصدار سورس العزايزي \n ☻ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ☻' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ☻ [تحديثات البوت](t.me/alaziza1) \n ☻ [قناه السورس](t.me/BANDA1M)')
end
...
usertext = '\n ☻ العضو » ['..result.title_..'](t.me/'..(username or 'BANDA1M')..')'
status  = '\n ☻ تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☻ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BANDA1M')..') \n ☻ '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ☻ العضو : {["..data.first_name_.."](T.ME/BANDA1M)}\n ☻ ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☻ عذرا » {["..data.first_name_.."](T.ME/BANDA1M)}\n ☻ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
𝐰𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝐬𝐨𝐮𝐫𝐜𝐞 𝐚𝐥-𝐚𝐳𝐚𝐢𝐳𝐲.😸
مرحبا بك في سورس العزايزي.💓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '┓ مبرمج السورس ┏ ',url="t.me/alazizy"}},
{{text = '┓ مطور السورس ┏', url="t.me/Ess_lam"}},
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ☻ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BANDA1M')..') \n ☻ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☻ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'BANDA1M')..') \n ☻ تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_," ☻ عذرا الملف لايدعم سورس العزايزي \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☻ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BANDA1M')..')'
status  = '\n ☻ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☻ العضو » '..userid..''
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☻ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'BANDA1M')..')'..'\n ☻ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'العزايزي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'العزايزي')
local BOYKA_Msg = {
'يوه '..Namebot..' زهق منك😒',
'نعم ياعيون '..Namebot..' 😻💓',
'عايز اي من '..Namebot..' 🙄💛',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'العزايزي').." غادر" or text == 'غادر' then  
...
if text == 'مبرمج السورس' or text == 'مصطفي' or text == 'يا سورس' then
local Text = [[
☻┃مبرمج السورس يمكنك..💓
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '╔ 𝙼𝙾𝚂𝚃𝙰𝙵𝙰 ╗ ',url="t.me/alazizy"}},
}
if text == 'مطور السورس' or text == 'اسلام' or text == 'يا سورس' then
local Text = [[
☻┃مبرمج السورس يمكنك..💓
☻┃التواصل معه عن طريق معرفه
]]
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'BANDA1M')..')'
local iduser = result.sender_user_id_
...
{
{text = '𝙰𝙻𝙰𝚉𝙸𝚉𝙰 𝙲𝙷𝙰𝙽𝙽𝙴𝙻⁦⁦ ㇱ ', url="t.me/BANDA1M"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'العزايزي')
