...
os.execute('wget https://raw.githubusercontent.com/mostafaaziza/tefa/master/BOYKA.lua')
...
local Text = [[
مرحبا بك في سورس الهكر برو 🦇
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'قناه السورس 🦇 ',url="t.me/SourceHacker"}},
{{text = 'قناه البرامجه 🦇', url="t.me/FlassTas10"}},
}
