...
𝐬𝐨𝐮𝐫𝐜𝐞 𝐚𝐥𝐚𝐳𝐢𝐳𝐲 𖤝
┈ ┈ ┈ ┈ ┈ ┈ ┈
✧ 𝙳𝙴𝚅1 ┆ ˹[𝙼𝙾𝚂𝚃𝙰𝙵𝙰𖤝](https://t.me/alazizy).
✧ 𝙳𝙴𝚅2 ┆ ˹[E𝚂𝚂𝙻𝙰𝙼𖤝](https://t.me/Ess_lam).
✧ 𝙲𝙷 ┆ [A𝙻𝙰𝚉𝙸𝚉𝙰𖤝](https://t.me/BANDA1M).
┈ ┈ ┈ ┈ ┈ ┈ ┈
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'العزايزي')
send(msg.chat_id_, msg.id_,'اسمي ['..Namebot..'] يروحي..🌚♥️')
end
